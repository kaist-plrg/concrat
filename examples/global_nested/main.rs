...
pub static mut n1_mutex: pthread_mutex_t = __anonunion_pthread_mutex_t_335460617 {
    __data: {
...
pub static mut n2_mutex: pthread_mutex_t = __anonunion_pthread_mutex_t_335460617 {
    __data: {
        let mut init = __pthread_mutex_s {
            __lock: 0 as libc::c_int,
            __count: 0 as libc::c_uint,
...
pub unsafe extern "C" fn f1() {
    pthread_mutex_lock(&mut n1_mutex);
    n1 += 1;
    pthread_mutex_unlock(&mut n1_mutex);
    pthread_mutex_lock(&mut n2_mutex);
    n2 += 1;
    pthread_mutex_unlock(&mut n2_mutex);
    pthread_mutex_lock(&mut n1_mutex);
    n1 += 1;
    pthread_mutex_lock(&mut n2_mutex);
    n1 += n2;
