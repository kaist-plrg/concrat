...
#pragma merger("0","/tmp/cil-DEEnZKqj.i","-pthread")
...
int n1[3]  ;
pthread_mutex_t num_mutex[3]  = {      {{0, 0U, 0, 0U, 0, (short)0, (short)0, {(struct __pthread_internal_list *)0,
...
#pragma merger("0","/tmp/cil-_QJynILs.i","-pthread")
