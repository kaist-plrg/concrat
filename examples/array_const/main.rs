...
pub unsafe extern "C" fn f1() {
    pthread_mutex_lock(&mut *num_mutex.as_mut_ptr().offset(0 as libc::c_int as isize));
    n1[0 as libc::c_int as usize] += 1;
    pthread_mutex_unlock(&mut *num_mutex.as_mut_ptr().offset(0 as libc::c_int as isize));
    pthread_mutex_lock(&mut *num_mutex.as_mut_ptr().offset(1 as libc::c_int as isize));
    n1[1 as libc::c_int as usize] += 1;
    pthread_mutex_unlock(&mut *num_mutex.as_mut_ptr().offset(1 as libc::c_int as isize));
    pthread_mutex_lock(&mut *num_mutex.as_mut_ptr().offset(2 as libc::c_int as isize));
    n1[2 as libc::c_int as usize] += 1;
    pthread_mutex_unlock(&mut *num_mutex.as_mut_ptr().offset(2 as libc::c_int as isize));
}
