...
#[thread_local]
static mut aco_gtls_last_word_fp: Option<unsafe extern "C" fn() -> ()> =
    Some(aco_default_protector_last_word as unsafe extern "C" fn() -> ());
#[thread_local]
static mut aco_gtls_fpucw_mxcsr: [*mut libc::c_void; 1] =
...
pub unsafe extern "C" fn aco_thread_init(
    ...
    if ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, *mut libc::c_void>(
        last_word_co_fp,
    ) as libc::c_ulong
...
pub unsafe extern "C" fn aco_share_stack_new2(
    ...
    if guard_page_enabled as libc::c_int != 0 as libc::c_int {
        ...
        if sz <= u_pgsz {
            ...
            if sz & u_pgsz.wrapping_sub(1 as libc::c_ulong) != 0 as libc::c_ulong {
                ...
                tmp___6 = (new_sz.wrapping_add(u_pgsz << 1 as libc::c_int) >= new_sz) as libc::c_int
                    as libc::c_long;
                if tmp___6 == 0 {
                    abort();
                }
                new_sz = (new_sz as libc::c_ulong).wrapping_add(u_pgsz << 1 as libc::c_int)
                    as size_t as size_t;
                tmp___7 = (sz.wrapping_div(u_pgsz).wrapping_add(2 as libc::c_ulong)
                    == new_sz.wrapping_div(u_pgsz)) as libc::c_int
                    as libc::c_long;
                if tmp___7 == 0 {
                    abort();
                }
    ...
    tmp___13 = (p as libc::c_ulong == 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___13 != 0 {
        fprintf(
            stderr,
    ...
    if guard_page_enabled as libc::c_int != 0 as libc::c_int {
        ...
        (*p).ptr = ((*p).real_ptr as uintptr_t).wrapping_add(u_pgsz) as *mut libc::c_void;
        (*p).real_sz = sz;
    ...
    u_p = ((*p).sz)
        .wrapping_sub(
            (::std::mem::size_of::<*mut libc::c_void>() as libc::c_ulong) << 1 as libc::c_int,
        )
    ...
    *fresh0 = ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, *mut libc::c_void>(
    ...
    (*p).align_limit = ((*p).sz).wrapping_sub(16 as libc::c_ulong).wrapping_sub(
        (::std::mem::size_of::<*mut libc::c_void>() as libc::c_ulong) << 1 as libc::c_int,
    );
    return p;
}
...
pub unsafe extern "C" fn aco_create(
    ...
    p = tmp as *mut aco_t;
    tmp___0 = (p as libc::c_ulong == 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___0 != 0 {
        fprintf(
            stderr,
    ...
    if main_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
        tmp___1 = (share_stack as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong)
            as libc::c_int as libc::c_long;
        if tmp___1 == 0 {
            abort();
        }
        (*p).share_stack = share_stack;
        (*p).reg[4 as libc::c_int as usize] =
            ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, *mut libc::c_void>(fp);
        (*p).reg[5 as libc::c_int as usize] = (*(*p).share_stack).align_retptr;
        (*p).reg[8 as libc::c_int as usize] = aco_gtls_fpucw_mxcsr[0 as libc::c_int as usize];
        (*p).main_co = main_co;
        (*p).arg = arg;
        (*p).fp = fp;
        ...
        tmp___2 = ((*p).save_stack.ptr as libc::c_ulong == 0 as *mut libc::c_void as libc::c_ulong)
            as libc::c_int as libc::c_long;
        if tmp___2 != 0 {
            fprintf(
                stderr,
...
pub unsafe extern "C" fn aco_resume(mut resume_co: *mut aco_t) {
    ...
    if resume_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
        if (*resume_co).main_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
    ...
    if (*(*resume_co).share_stack).owner as libc::c_ulong != resume_co as libc::c_ulong {
            ...
            != 0 as *mut libc::c_void as libc::c_ulong
        {
            ...
            (*owner_co).save_stack.valid_sz = ((*(*owner_co).share_stack).align_retptr
                as uintptr_t)
            ...
            if (*owner_co).save_stack.sz < (*owner_co).save_stack.valid_sz {
                ...
                loop {
                    ...
                    tmp___4 = ((*owner_co).save_stack.sz > 0 as libc::c_ulong) as libc::c_int
                        as libc::c_long;
                    if tmp___4 == 0 {
                        abort();
                    }
            ...
            if (*owner_co).save_stack.valid_sz > 0 as libc::c_ulong {
                if (*owner_co).reg[5 as libc::c_int as usize] as uintptr_t & 15 as libc::c_ulong
                    == 0 as libc::c_ulong
                {
                        ...
                        == 0 as libc::c_ulong
                    {
                            ...
                            == 8 as libc::c_ulong
                        {
                            ...
                            memcpy(
                                (*owner_co).save_stack.ptr,
                                (*owner_co).reg[5 as libc::c_int as usize] as *const libc::c_void,
                                (*owner_co).save_stack.valid_sz,
                            );
                        }
                    } else {
                ...
                (*owner_co).save_stack.ct_save = ((*owner_co).save_stack.ct_save).wrapping_add(1);
            }
        ...
        if (*resume_co).save_stack.valid_sz > 0 as libc::c_ulong {
            if (*resume_co).save_stack.ptr as uintptr_t & 15 as libc::c_ulong == 0 as libc::c_ulong
            {
                if ((*(*resume_co).share_stack).align_retptr as uintptr_t)
                    ...
                    == 0 as libc::c_ulong
                {
                    if (*resume_co).save_stack.valid_sz & 15 as libc::c_ulong == 8 as libc::c_ulong
                    {
            ...
            (*resume_co).save_stack.ct_restore =
                ((*resume_co).save_stack.ct_restore).wrapping_add(1);
        }
        ...
        (*(*resume_co).share_stack).align_validsz = ((*resume_co).save_stack.valid_sz)
            .wrapping_add(::std::mem::size_of::<*mut libc::c_void>() as libc::c_ulong);
...
pub static mut gl_race_aco_yield_ct_mutex: pthread_mutex_t =
...
pub unsafe extern "C" fn foo(mut ct: libc::c_int) {
    ...
    tmp = (aco_gtls_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp == 0 {
        abort();
    }
    tmp___0 = ((*aco_gtls_co).main_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong)
        as libc::c_int as libc::c_long;
    if tmp___0 == 0 {
        abort();
    }
...
pub unsafe extern "C" fn co_fp0() {
    ...
    let mut tmp___6: libc::c_long = 0;
    this_co = aco_gtls_co;
    tmp = !((*this_co).main_co as libc::c_ulong == 0 as *mut libc::c_void as libc::c_ulong)
        as libc::c_int as libc::c_long;
    if tmp == 0 {
        abort();
    }
    tmp___0 = (::std::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, libc::c_ulong>(
        (*this_co).fp,
    ) == ::std::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, *mut libc::c_void>(
        Some(co_fp0 as unsafe extern "C" fn() -> ()),
    ) as libc::c_ulong) as libc::c_int as libc::c_long;
    if tmp___0 == 0 {
        abort();
    }
    tmp___1 = ((*this_co).is_end as libc::c_int == 0 as libc::c_int) as libc::c_int as libc::c_long;
    if tmp___1 == 0 {
        abort();
    }
    ct = 0 as libc::c_int;
    ...
    tmp___2 = ((*(*aco_gtls_co).share_stack).owner as libc::c_ulong == aco_gtls_co as libc::c_ulong)
        as libc::c_int as libc::c_long;
    if tmp___2 == 0 {
        abort();
    }
    ...
    tmp___4 = ((*aco_gtls_co).main_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong)
        as libc::c_int as libc::c_long;
    if tmp___4 == 0 {
        abort();
    }
...
pub unsafe extern "C" fn pmain(mut pthread_in_arg: *mut libc::c_void) -> *mut libc::c_void {
    ...
    while idx < ::std::mem::size_of::<pthread_t>() as libc::c_ulong {
        printf(
            ...
            *(&mut t as *mut pthread_t as *mut uint8_t).offset(idx as isize) as libc::c_int,
        );
        idx = idx.wrapping_add(1);
    }
    printf(b"\n\0" as *const u8 as *const libc::c_char);
    aco_thread_init(::std::mem::transmute::<
        *mut libc::c_void,
        Option<unsafe extern "C" fn() -> ()>,
    >(0 as *mut libc::c_void));
    tmp___1 = aco_create(
        ...
        ::std::mem::transmute::<*mut libc::c_void, Option<unsafe extern "C" fn() -> ()>>(
            0 as *mut libc::c_void,
        ),
        0 as *mut libc::c_void,
    );
    main_co = tmp___1;
    tmp___2 = (main_co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___2 == 0 {
        abort();
    }
    ...
    sstk = tmp___3;
    tmp___4 = (sstk as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___4 == 0 {
        abort();
    }
    ...
    sstk2 = tmp___5;
    tmp___6 = (sstk2 as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___6 == 0 {
        abort();
    }
    ...
    co = tmp___7;
    tmp___8 = (co as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___8 == 0 {
        abort();
    }
    ...
    co3 = tmp___10;
    tmp___11 = (co2 as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___11 == 0 {
        abort();
    }
    tmp___12 = (co3 as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong) as libc::c_int
        as libc::c_long;
    if tmp___12 == 0 {
        abort();
    }
    ct = 0 as libc::c_int;
    while ct < 6 as libc::c_int {
        tmp___13 = ((*co).is_end as libc::c_int == 0 as libc::c_int) as libc::c_int as libc::c_long;
        if tmp___13 == 0 {
            abort();
        }
        aco_resume(co);
        ...
        tmp___15 =
            ((*co2).is_end as libc::c_int == 0 as libc::c_int) as libc::c_int as libc::c_long;
        if tmp___15 == 0 {
            abort();
        }
        aco_resume(co2);
        ...
        tmp___17 =
            ((*co3).is_end as libc::c_int == 0 as libc::c_int) as libc::c_int as libc::c_long;
        if tmp___17 == 0 {
            abort();
        }
        aco_resume(co3);
