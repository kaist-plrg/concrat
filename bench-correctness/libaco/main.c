...
#pragma merger("0","/tmp/cil-OUl3NMhL.i","")
...
{ 
  ...
  {
  _Static_assert(sizeof(void *) == 8UL, "require \'sizeof(void*) == 8\'");
  _Static_assert(sizeof(unsigned __int128 ) == 16UL, "require \'sizeof(__uint128_t) == 16\'");
  _Static_assert(sizeof(int ) >= 4UL, "require \'sizeof(int) >= 4\'");
...
#pragma merger("0","/tmp/cil-kRGBalRt.i","")
