...
#![feature(asm, c_variadic, extern_types, label_break_value, register_tool, rustc_private, untagged_unions)]
#[macro_use]
...
unsafe fn main_0(
    ...
    if !(r_index.head).is_null() {
        current_block = 2348941171182318023;
        ...
        if !(schema_list.head).is_null() {
            ...
            if !(table_list.head).is_null() {
                current_block_117 = 17703328447480851050;
        ...
        if alldb {
            ...
            if !(table_list.head).is_null() {
                current_block_149 = 3512317194029868722;
            } else if !(parent_table_list.head).is_null() {
                current_block_149 = 3512317194029868722;
            } else {
        ...
        2348941171182318023 => {
            ...
            if !(r_index.head).is_null() {
                if !(parent_table_list.head).is_null() {
                    ...
                    current_block = 16394430471086340201;
                }
            } else {
                current_block = 16394430471086340201;
            }
                ...
                _ => {
                    if !(r_index.head).is_null() {
                        if only_indexes {
                            ...
                            current_block = 3430707816556096878;
                        }
                    } else {
                        current_block = 3430707816556096878;
                    }
                        ...
                        _ => {
                            if !(r_index.head).is_null() {
                                if !(exclude_extension_list.head).is_null() {
                                    ...
                                    current_block = 13723051584774181210;
                                }
                            } else {
                                current_block = 13723051584774181210;
                            }
                            match current_block {
                                ...
                                _ => {
                                    if only_indexes {
                                        if !(table_list.head).is_null() {
                                            current_block = 7090046386422058376;
                                        } else if !(parent_table_list.head).is_null() {
                                            current_block = 7090046386422058376;
                                        } else {
                                        ...
                                        _ => {
                                            ...
                                            if only_indexes {
                                                if !(exclude_extension_list.head).is_null() {
                                                    ...
                                                    current_block_110 = 15334144911182010158;
                                                }
                                            } else {
                                                current_block_110 = 15334144911182010158;
                                            }
                                            match current_block_110 {
                                                15334144911182010158 => {
                                                    if alldb {
...
unsafe extern "C" fn preliminary_checks(
    ...
    if !tmp {
        ...
        if tmp___7 as libc::c_uint == 2 as libc::c_uint {
            ...
            if tmp___5 {
                current_block_29 = 17532298407502792976;
            } else {
    ...
    if tmp___0 {
        ...
        if tmp___1 {
            ...
            *fresh2 = tablespace as *const libc::c_char;
            ...
            if num_tables != 0 {
                current_block_73 = 2289417282303808368;
    ...
    loop {
        ...
        if num_workers <= 1 as libc::c_int {
            ...
            if tmp___0 == 0 {
                ...
                current_block = 12279650498967787992;
                break;
            }
        }
        i += 1;
        ...
        15897653523371991391 => {
            if num_workers > 1 as libc::c_int {
                ...
                's_197: while num_active_workers > 0 as libc::c_int {
                    ...
                    ret = libc::poll(input_fds as _, num_workers as nfds_t, 3000 as libc::c_int);
                        ...
                        if !tmp___19 {
                            ...
                            loop {
                                ...
                                if tmp___21 as libc::c_uint != 1 as libc::c_uint {
                                    ...
                                    current_block = 12057497505275398126;
                                    break;
                                } else {
                                    PQclear(res);
                                    res = 0 as *mut libc::c_void as *mut PGresult;
                ...
                if tmp___5 > 0 as libc::c_int {
                    if terminate {
                        ...
                        if tmp___6 >= 80400 as libc::c_int {
                            ...
                            current_block = 66235089907947400;
                        }
                    } else {
                        current_block = 66235089907947400;
                    }
    ...
    if tmp___0 {
        ...
        if tmp___1 {
            if !(r_index.head).is_null() {
                ...
                if !(table_list.head).is_null() {
                    current_block = 15913293137924126376;
                } else if !(parent_table_list.head).is_null() {
                    current_block = 15913293137924126376;
                } else {
    ...
    's_57: while last == 0 {
        if *p.offset(0 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int {
            ...
            current_block_34 = 17407779659766490442;
                ...
                != 47 as libc::c_int
            {
            current_block_34 = 11621265595339648799;
        } else {
            current_block_34 = 17407779659766490442;
        }
