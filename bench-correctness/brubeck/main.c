...
union __anonunion_as_879286020 {
...
struct brubeck_metric {
   ...
   union __anonunion_as_879286020 as ;
   char key[] ;
};
...
#pragma merger("0","/tmp/cil-upitDgWY.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-YQA1GN7q.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-KtCT44vm.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-p681If5G.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-i02Dx4yF.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-MquUvXWK.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-YNzaHH1b.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-3zTUOHvx.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-IQIniq9E.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-SsP_BzL8.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-KgpDR1Ci.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-_GL7vzxw.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-DkXQXYry.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-T0vuh9b5.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-0aL4WLPJ.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-_JcdJaEt.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-ygRLHBHb.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-7ks99wPW.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
#pragma merger("0","/tmp/cil-YrcodZlg.i","-g,-Wall,-O3,-Wno-strict-aliasing")
extern int fputs(char const   * __restrict  __s , FILE * __restrict  __stream ) ;
struct sput __sput ;
static void check_tags_equal(struct brubeck_tag_set  const  *x , struct brubeck_tag_set  const  *y ,
...
{ 
  ...
  {
  while (1) {
    if ((int )__sput.initialized != 6) {
      fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
      exit(1);
    }
    if (! __sput.suite.name) {
      fputs((char const   * __restrict  )"sput_enter_suite() omitted\n", (FILE * __restrict  )__sput.out);
      exit(1);
    }
    if (! __sput.test.name) {
      fputs((char const   * __restrict  )"sput_run_test() omitted\n", (FILE * __restrict  )__sput.out);
      exit(1);
    }
    if ((unsigned long )description != (unsigned long )((void *)0)) {
      __sput.check.name = description;
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 7UL;
    __sput.check.cond = "y->num_tags == x->num_tags";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((int const   )y->num_tags == (int const   )x->num_tags)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
      ...
      (__sput.suite.nok) ++;
      fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"[%lu:%lu]  %s:#%lu  \"%s\"  FAIL\n!    Type:      %s\n!    Condition: %s\n!    Line:      %lu\n",
              __sput.suite.nr, __sput.suite.checks, __sput.test.name, __sput.test.nr,
              __sput.check.name, __sput.check.type, __sput.check.cond, __sput.check.line);
    } else {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      ...
      (__sput.suite.ok) ++;
      fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"[%lu:%lu]  %s:#%lu  \"%s\"  pass\n",
              __sput.suite.nr, __sput.suite.checks, __sput.test.name, __sput.test.nr,
              __sput.check.name);
    }
    break;
  ...
  while (i < (int )y->num_tags) {
    while (1) {
      ...
      __sput.check.line = 9UL;
      __sput.check.cond = "strcmp(x->tags[i].key, y->tags[i].key) == 0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      tmp = strcmp((char const   *)x->tags[i].key, (char const   *)y->tags[i].key);
      if (tmp == 0) {
        if ((int )__sput.initialized != 6) {
          fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
          exit(1);
    ...
    while (1) {
      ...
      __sput.check.line = 11UL;
      __sput.check.cond = "strcmp(x->tags[i].value, y->tags[i].value) == 0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      tmp___0 = strcmp((char const   *)x->tags[i].value, (char const   *)y->tags[i].value);
      if (tmp___0 == 0) {
        if ((int )__sput.initialized != 6) {
          fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
          exit(1);
...
static void check_equal(struct brubeck_tag_set  const  *x , struct brubeck_tag_set  const  *y ,
                        char const   *description ) 
{ 
  ...
  while (1) {
    ...
    __sput.check.line = 18UL;
    __sput.check.cond = "(x && !y) || (y && !x)";
  ...
  while (1) {
    ...
    __sput.check.line = 19UL;
    __sput.check.cond = "y->tag_len == x->tag_len";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((int const   )y->tag_len == (int const   )x->tag_len)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
struct brubeck_tag_set  const  *parse(char const   *source ) 
{ 
  char *str ;
  uint16_t len ;
  size_t tmp ;
  struct brubeck_tag_set *tmp___0 ;
  ...
  return ((struct brubeck_tag_set  const  *)tmp___0);
}
}
static void check_parse(char const   *source , struct brubeck_tag_set *expected_without_tags ,
                        struct brubeck_tag  const  *tag_arr ) 
{ 
  ...
  {
  tmp = malloc(sizeof(struct brubeck_tag_set ) + sizeof(struct brubeck_tag ) * (unsigned long )expected_without_tags->num_tags);
  expected = (struct brubeck_tag_set *)tmp;
  memcpy((void * __restrict  )expected, (void const   * __restrict  )expected_without_tags,
         sizeof(struct brubeck_tag_set ));
  memcpy((void * __restrict  )(expected->tags), (void const   * __restrict  )tag_arr,
         sizeof(struct brubeck_tag ) * (unsigned long )expected_without_tags->num_tags);
  tmp___0 = parse(source);
  tags = tmp___0;
  check_equal((struct brubeck_tag_set  const  *)expected, tags, source);
  return;
}
}
void test_tag_parsing(void) 
{ 
  struct brubeck_tag __constr_expr_0[0] ;
  struct brubeck_tag_set __constr_expr_1 ;
  struct brubeck_tag __constr_expr_2[0] ;
  struct brubeck_tag_set __constr_expr_3 ;
  struct brubeck_tag __constr_expr_4[1] ;
  struct brubeck_tag_set __constr_expr_5 ;
  struct brubeck_tag __constr_expr_6[1] ;
  struct brubeck_tag_set __constr_expr_7 ;
  struct brubeck_tag __constr_expr_8[1] ;
  struct brubeck_tag_set __constr_expr_9 ;
  struct brubeck_tag __constr_expr_10[2] ;
  struct brubeck_tag_set __constr_expr_11 ;
  struct brubeck_tag __constr_expr_12[2] ;
  struct brubeck_tag_set __constr_expr_13 ;
  struct brubeck_tag __constr_expr_14[0] ;
  struct brubeck_tag_set __constr_expr_15 ;
  struct brubeck_tag __constr_expr_16[1] ;
  struct brubeck_tag_set __constr_expr_17 ;
  struct brubeck_tag __constr_expr_18[1] ;
  struct brubeck_tag_set __constr_expr_19 ;

  {
  __constr_expr_1.index = 0U;
  __constr_expr_1.tag_len = (uint16_t )0;
  __constr_expr_1.num_tags = (uint16_t )0;
  check_parse("", & __constr_expr_1, (struct brubeck_tag  const  *)(__constr_expr_0));
  __constr_expr_3.index = 0U;
  __constr_expr_3.tag_len = (uint16_t )3;
  __constr_expr_3.num_tags = (uint16_t )0;
  check_parse("foo", & __constr_expr_3, (struct brubeck_tag  const  *)(__constr_expr_2));
  __constr_expr_4[0].key = "foo";
  __constr_expr_4[0].value = "bar";
  __constr_expr_5.index = 0U;
  __constr_expr_5.tag_len = (uint16_t )7;
  __constr_expr_5.num_tags = (uint16_t )1;
  check_parse("foo=bar", & __constr_expr_5, (struct brubeck_tag  const  *)(__constr_expr_4));
  __constr_expr_6[0].key = "foo";
  __constr_expr_6[0].value = "bar";
  __constr_expr_7.index = 0U;
  __constr_expr_7.tag_len = (uint16_t )8;
  __constr_expr_7.num_tags = (uint16_t )1;
  check_parse(",foo=bar", & __constr_expr_7, (struct brubeck_tag  const  *)(__constr_expr_6));
  __constr_expr_8[0].key = "foo";
  __constr_expr_8[0].value = "bar";
  __constr_expr_9.index = 0U;
  __constr_expr_9.tag_len = (uint16_t )9;
  __constr_expr_9.num_tags = (uint16_t )1;
  check_parse(",foo=bar,", & __constr_expr_9, (struct brubeck_tag  const  *)(__constr_expr_8));
  __constr_expr_10[0].key = "foo";
  __constr_expr_10[0].value = "bar";
  __constr_expr_10[1].key = "baz";
  __constr_expr_10[1].value = "42";
  __constr_expr_11.index = 0U;
  __constr_expr_11.tag_len = (uint16_t )16;
  __constr_expr_11.num_tags = (uint16_t )2;
  check_parse("s,foo=bar,baz=42", & __constr_expr_11, (struct brubeck_tag  const  *)(__constr_expr_10));
  __constr_expr_12[0].key = "foo";
  __constr_expr_12[0].value = "bar";
  __constr_expr_12[1].key = "baz";
  __constr_expr_12[1].value = "42";
  __constr_expr_13.index = 0U;
  __constr_expr_13.tag_len = (uint16_t )17;
  __constr_expr_13.num_tags = (uint16_t )2;
  check_parse(",foo=bar,,baz=42,", & __constr_expr_13, (struct brubeck_tag  const  *)(__constr_expr_12));
  __constr_expr_15.index = 0U;
  __constr_expr_15.tag_len = (uint16_t )20;
  __constr_expr_15.num_tags = (uint16_t )0;
  check_parse("s,junk,=,junk=,=junk", & __constr_expr_15, (struct brubeck_tag  const  *)(__constr_expr_14));
  __constr_expr_16[0].key = "foo";
  __constr_expr_16[0].value = "bar";
  __constr_expr_17.index = 0U;
  __constr_expr_17.tag_len = (uint16_t )11;
  __constr_expr_17.num_tags = (uint16_t )1;
  check_parse("s,foo===bar", & __constr_expr_17, (struct brubeck_tag  const  *)(__constr_expr_16));
  __constr_expr_18[0].key = "foo";
  __constr_expr_18[0].value = "bar";
  __constr_expr_19.index = 0U;
  __constr_expr_19.tag_len = (uint16_t )8;
  __constr_expr_19.num_tags = (uint16_t )1;
  check_parse("foo=bar,", & __constr_expr_19, (struct brubeck_tag  const  *)(__constr_expr_18));
  return;
}
}
struct brubeck_tag_set  const  *get_tag_set(struct brubeck_tags_t *tags , char const   *tag_str ) 
{ 
  uint16_t tag_str_len ;
  size_t tmp ;
  struct brubeck_tag_set  const  *tmp___0 ;
...
{ 
  struct brubeck_tags_t *tags ;
  brubeck_tags_t *tmp ;
  struct brubeck_tag_set  const  *t1 ;
  struct brubeck_tag_set  const  *t2 ;
  char const   *str ;
  struct brubeck_tag_set  const  *tmp___0 ;
  struct brubeck_tag_set  const  *tmp___1 ;

  {
  tmp = brubeck_tags_create((uint64_t const   )1024);
  tags = tmp;
  str = "s,foo=bar";
  ...
  while (1) {
    ...
    if ((unsigned long )"not null" != (unsigned long )((void *)0)) {
      __sput.check.name = "not null";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 91UL;
    __sput.check.cond = "t1 == NULL";
    __sput.check.type = "fail-if";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
  ...
  while (1) {
    ...
    if ((unsigned long )"index" != (unsigned long )((void *)0)) {
      __sput.check.name = "index";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 93UL;
    __sput.check.cond = "t1->index == 1";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (t1->index == 1U)) {
  ...
  while (1) {
    ...
    __sput.check.line = 96UL;
    __sput.check.cond = "t2 == NULL";
    __sput.check.type = "fail-if";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
  ...
  while (1) {
    ...
    if ((unsigned long )"caching" != (unsigned long )((void *)0)) {
      __sput.check.name = "caching";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 98UL;
    __sput.check.cond = "t1 == t2";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
  ...
  while (1) {
    ...
    __sput.check.line = 104UL;
    __sput.check.cond = "t2->index == 2";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (t2->index == 2U)) {
...
void check_tag_offset(char const   *str , uint16_t const   offset ) 
{ 
  uint16_t tmp ;
  ...
  while (1) {
    ...
    __sput.check.line = 109UL;
    __sput.check.cond = "brubeck_tag_offset(str) == offset";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    tmp = (uint16_t )brubeck_tag_offset(str);
    if ((int const   )tmp == (int const   )offset) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
{ 
  ...
  {
  check_tag_offset("", (uint16_t const   )0);
  check_tag_offset("no.tags", (uint16_t const   )7);
  check_tag_offset("has.tags,foo=bar,baz=42", (uint16_t const   )8);
  check_tag_offset("has.tags#foo=bar,baz=42", (uint16_t const   )8);
  return;
}
}
#pragma merger("0","/tmp/cil-CNrj2ziH.i","-g,-Wall,-O3,-Wno-strict-aliasing")
static struct brubeck_metric *new_metric___0(char const   *name ) 
{ 
  size_t name_len ;
  size_t tmp ;
  struct brubeck_metric *metric ;
  ...
  tmp = strlen(name);
  name_len = tmp;
  tmp___0 = malloc((sizeof(struct brubeck_metric ) + name_len) + 1UL);
  metric = (struct brubeck_metric *)tmp___0;
  memcpy((void * __restrict  )(metric->key), (void const   * __restrict  )name, name_len);
  metric->key[name_len] = (char)0;
  metric->key_len = (uint16_t )name_len;
  return (metric);
}
}
void test_mstore__save(void) ;
static int const   nmetrics  =    (int const   )15000;
void test_mstore__save(void) 
{ 
  ...
  uint16_t len ;
  int tmp___0 ;
  struct brubeck_metric *tmp___1 ;

  {
  store = brubeck_hashtable_new((uint64_t const   )4096);
  i = 0;
  while (i < (int )nmetrics) {
    sprintf((char * __restrict  )(buffer), (char const   * __restrict  )"github.test.metric.%d",
            i);
    metric = new_metric___0((char const   *)(buffer));
    tmp = brubeck_hashtable_insert(store, (char const   *)(metric->key), metric->key_len,
                                   metric);
    if (! tmp) {
      break;
    }
  ...
  while (1) {
    ...
    if ((unsigned long )"stored 15000 metrics in table" != (unsigned long )((void *)0)) {
      __sput.check.name = "stored 15000 metrics in table";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 34UL;
    __sput.check.cond = "i == nmetrics";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (i == (int )nmetrics)) {
  ...
  i = 0;
  while (i < (int )(nmetrics + 1)) {
    tmp___0 = sprintf((char * __restrict  )(buffer___0), (char const   * __restrict  )"github.test.metric.%d",
                      i);
    len = (uint16_t )tmp___0;
    tmp___1 = brubeck_hashtable_find(store, (char const   *)(buffer___0), len);
    if (! tmp___1) {
      break;
    }
    i ++;
  ...
  while (1) {
    ...
    if ((unsigned long )"lookup all metrics from table" != (unsigned long )((void *)0)) {
      __sput.check.name = "lookup all metrics from table";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 47UL;
    __sput.check.cond = "i == nmetrics";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
...
#pragma merger("0","/tmp/cil-KtqXV2_7.i","-g,-Wall,-O3,-Wno-strict-aliasing")
extern int pthread_join(pthread_t __th , void **__thread_return ) ;
__inline static void spawn_threads(void *(*thread_ptr)(void * ) , void *ptr ) 
{ 
  size_t i ;
  ...
  while (i < 16UL) {
    pthread_create((pthread_t * __restrict  )(& threads[i]), (pthread_attr_t const   * __restrict  )((void *)0),
                   thread_ptr, (void * __restrict  )ptr);
    i ++;
  }
  i = (size_t )0;
  while (i < 16UL) {
...
{ 
  ...
  {
  spt = (struct spinlock_test *)ptr;
  i = (size_t )0;
  while (i < 4096UL) {
    pthread_spin_lock(& spt->lock);
    v = (double volatile   )spt->value;
    v += (double volatile   )0.5;
    spt->value = (double )v;
...
{ 
  ...
  spt.value = 0.0;
  spawn_threads(& thread_spinlock, (void *)(& spt));
  while (1) {
    if ((int )__sput.initialized != 6) {
      fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
      exit(1);
    ...
    if ((unsigned long )"spinlock doesn\'t race" != (unsigned long )((void *)0)) {
      __sput.check.name = "spinlock doesn\'t race";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 38UL;
    __sput.check.cond = "spt.value == (double)(INCREMENTS * MAX_THREADS * DELTA)";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (spt.value == (double )65536 * 0.5)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
#pragma merger("0","/tmp/cil-9RO29dFM.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
{ 
  ...
  {
  memset((void *)(& test.h), 0, sizeof(test.h));
  pthread_spin_init(& test.lock, 0);
  spawn_threads(& thread_histo, (void *)(& test));
  return;
}
}
...
{ 
  ...
  while (1) {
    ...
    if ((unsigned long )"histogram size" != (unsigned long )((void *)0)) {
      __sput.check.name = "histogram size";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 48UL;
    __sput.check.cond = "h.size == 1";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((int )h.size == 1)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"histogram value count" != (unsigned long )((void *)0)) {
      __sput.check.name = "histogram value count";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 49UL;
    __sput.check.cond = "h.count == 1";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (h.count == 1U)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.min" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.min";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 53UL;
    __sput.check.cond = "sample.min == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.min == 42.0)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.max" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.max";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 54UL;
    __sput.check.cond = "sample.max == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.max == 42.0)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.percentile[3]" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.percentile[3]";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 55UL;
    __sput.check.cond = "sample.percentile[3] == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.percentile[3] == 42.0)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.mean" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.mean";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 56UL;
    __sput.check.cond = "sample.mean == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.mean == 42.0)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.count" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.count";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 57UL;
    __sput.check.cond = "sample.count == 1";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.count == (value_t )1)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.sum" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.sum";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 58UL;
    __sput.check.cond = "sample.sum == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.sum == 42.0)) {
...
{ 
  ...
  while (1) {
    ...
    __sput.check.line = 74UL;
    __sput.check.cond = "sample.max == 1.3e12";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.max == 1.3e12)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    if ((unsigned long )"sample.median" != (unsigned long )((void *)0)) {
      __sput.check.name = "sample.median";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 75UL;
    __sput.check.cond = "sample.median == 42.0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.median == 42.0)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
{ 
  ...
  while (i < 8UL) {
    j = (size_t )0;
    while (j < 128UL) {
      brubeck_histo_push(& h, (double )(j + 1UL), 1.0);
      j ++;
    }
    while (1) {
      if ((int )__sput.initialized != 6) {
      ...
      __sput.check.line = 89UL;
      __sput.check.cond = "h.size == 128";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! ((int )h.size == 128)) {
    ...
    while (1) {
      ...
      __sput.check.line = 90UL;
      __sput.check.cond = "h.count == 128";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (h.count == 128U)) {
    ...
    while (1) {
      ...
      __sput.check.line = 94UL;
      __sput.check.cond = "sample.min == 1.0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.min == 1.0)) {
    ...
    while (1) {
      ...
      __sput.check.line = 95UL;
      __sput.check.cond = "sample.max == 128.0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.max == 128.0)) {
    ...
    while (1) {
      ...
      __sput.check.line = 96UL;
      __sput.check.cond = "sample.percentile[3] == 127.0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.percentile[3] == 127.0)) {
        if ((int )__sput.initialized != 6) {
          fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
          exit(1);
        }
    ...
    while (1) {
      ...
      __sput.check.line = 97UL;
      __sput.check.cond = "sample.mean == 64.5";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.mean == 64.5)) {
    ...
    while (1) {
      ...
      __sput.check.line = 98UL;
      __sput.check.cond = "sample.count == 128";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.count == (value_t )128)) {
        if ((int )__sput.initialized != 6) {
          fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
          exit(1);
        }
    ...
    while (1) {
      ...
      __sput.check.line = 99UL;
      __sput.check.cond = "sample.sum == 8256.0";
      __sput.check.type = "fail-unless";
      (__sput.test.nr) ++;
      (__sput.suite.checks) ++;
      if (! (sample.sum == 8256.0)) {
        if ((int )__sput.initialized != 6) {
          fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
          exit(1);
        }
...
{ 
  ...
  j = (size_t )0;
  while (j < 128UL) {
    brubeck_histo_push(& h, (double )(j + 1UL), 10.0);
    j ++;
  }
  while (1) {
    if ((int )__sput.initialized != 6) {
  ...
  while (1) {
    ...
    __sput.check.line = 114UL;
    __sput.check.cond = "h.count == 1280";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (h.count == 1280U)) {
  ...
  while (1) {
    ...
    __sput.check.line = 122UL;
    __sput.check.cond = "sample.count == 1280";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.count == (value_t )1280)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
static unsigned long const   HISTO_CAP  =    (size_t const   )65535;
void test_histogram__capacity(void) 
{ 
  struct brubeck_histo h ;
  struct brubeck_histo_sample sample ;
  ...
  memset((void *)(& h), 0, sizeof(h));
  j = (size_t )0;
  while (j < (size_t )(HISTO_CAP + 500UL)) {
    brubeck_histo_push(& h, (double )(j + 1UL), 1.0);
    j ++;
  }
  while (1) {
    ...
    __sput.check.line = 138UL;
    __sput.check.cond = "h.size == HISTO_CAP";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((unsigned long const   )h.size == HISTO_CAP)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    __sput.check.line = 139UL;
    __sput.check.cond = "h.count == (HISTO_CAP + 500)";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((unsigned long const   )h.count == HISTO_CAP + 500UL)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    __sput.check.line = 144UL;
    __sput.check.cond = "sample.max == (double)HISTO_CAP";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.max == (double )HISTO_CAP)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    __sput.check.line = 145UL;
    __sput.check.cond = "sample.count == (HISTO_CAP + 500)";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.count == (value_t )(HISTO_CAP + 500UL))) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    __sput.check.line = 152UL;
    __sput.check.cond = "h.count == ((HISTO_CAP + 500) * 10)";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((unsigned long const   )h.count == (HISTO_CAP + 500UL) * 10UL)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
  ...
  while (1) {
    ...
    __sput.check.line = 158UL;
    __sput.check.cond = "sample.count == ((HISTO_CAP + 500) * 10)";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (sample.count == (value_t )((HISTO_CAP + 500UL) * 10UL))) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
#pragma merger("0","/tmp/cil-9hebt63F.i","-g,-Wall,-O3,-Wno-strict-aliasing")
static void must_parse(char const   *msg_text , double value , double sample , uint8_t modifiers ) 
{ 
  struct brubeck_statsd_msg msg ;
  char buffer[128] ;
  size_t len ;
  ...
  tmp = strlen(msg_text);
  len = tmp;
  memcpy((void * __restrict  )(buffer), (void const   * __restrict  )msg_text, len);
  while (1) {
    if ((int )__sput.initialized != 6) {
      fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
      exit(1);
    ...
    if ((unsigned long )msg_text != (unsigned long )((void *)0)) {
      __sput.check.name = msg_text;
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 15UL;
    __sput.check.cond = "brubeck_statsd_msg_parse(&msg, buffer, buffer + len, 0.001) == 0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    tmp___0 = brubeck_statsd_msg_parse(& msg, buffer, buffer + len, (double const   )0.001);
    if (tmp___0 == 0) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
  ...
  while (1) {
    ...
    if ((unsigned long )"msg.value == expected" != (unsigned long )((void *)0)) {
      __sput.check.name = "msg.value == expected";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 16UL;
    __sput.check.cond = "value == msg.value";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! (value == msg.value)) {
  ...
  while (1) {
    ...
    if ((unsigned long )"msg.sample_rate == expected" != (unsigned long )((void *)0)) {
      __sput.check.name = "msg.sample_rate == expected";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 17UL;
    __sput.check.cond = "sample == msg.sample_freq";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
  ...
  while (1) {
    ...
    if ((unsigned long )"msg.modifiers == expected" != (unsigned long )((void *)0)) {
      __sput.check.name = "msg.modifiers == expected";
    } else {
      __sput.check.name = "Unlabeled Check";
    }
    __sput.check.line = 18UL;
    __sput.check.cond = "modifiers == msg.modifiers";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    if (! ((int )modifiers == (int )msg.modifiers)) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
      }
...
static void must_not_parse(char const   *msg_text ) 
{ 
  struct brubeck_statsd_msg msg ;
  char buffer[128] ;
  size_t len ;
...
{ 
  ...
  {
  must_parse("github.auth.fingerprint.sha1:1|c", (double )1, 1.0, (uint8_t )0);
  must_parse("github.auth.fingerprint.sha1:1|c|@0.1", (double )1, 10.0, (uint8_t )0);
  must_parse("github.auth.fingerprint.sha1:1|g", (double )1, 1.0, (uint8_t )0);
  must_parse("lol:2|ms", 0.002, 1.0, (uint8_t )0);
  must_parse("this.is.sparta:199812|C", (double )199812, 1.0, (uint8_t )0);
  must_parse("this.is.sparta:0012|h", (double )12, 1.0, (uint8_t )0);
  must_parse("this.is.sparta:23.23|g", 23.23, 1.0, (uint8_t )0);
  must_parse("this.is.sparta:0.232030|g", 0.23203, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g", 1234567.89, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@0.025", 1234567.89, 40.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@0.25", 1234567.89, 4.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@0.01", 1234567.89, 100.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@000.0100", 1234567.89, 100.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@1.0", 1234567.89, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@1", 1234567.89, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g|@1.", 1234567.89, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:|g", 0.0, 1.0, (uint8_t )0);
  must_parse("this.are.some.floats:1234567.89|g", 1234567.89, 1.0, (uint8_t )0);
  must_parse("gauge.increment:+1|g", (double )1, 1.0, (uint8_t )1);
  must_parse("gauge.decrement:-1|g", (double )-1, 1.0, (uint8_t )1);
...
#pragma merger("0","/tmp/cil-doqqGTuD.i","-g,-Wall,-O3,-Wno-strict-aliasing")
...
{ 
  ...
  {
  while (1) {
    memset((void *)(& __sput), 0, sizeof(__sput));
    __sput.out = stdout;
    __sput.time.start = time((time_t *)((void *)0));
    __sput.initialized = (char)6;
    break;
  }
  while (1) {
    if ((int )__sput.initialized != 6) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
        break;
      }
    }
    if ((unsigned long )"histogram: time/data series aggregation" != (unsigned long )((void *)0)) {
      __sput.suite.name = "histogram: time/data series aggregation";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__sampling";
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__single_element";
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__large_range";
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__multisamples";
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__with_sample_rate";
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_histogram__capacity";
  ...
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___0 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___0 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___0);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if ((unsigned long )"mstore: concurrency test for metrics hash table" != (unsigned long )((void *)0)) {
      __sput.suite.name = "mstore: concurrency test for metrics hash table";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
    (__sput.overall.suites) ++;
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_mstore__save";
    test_mstore__save();
    break;
  }
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___1 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___1 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___1);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if ((unsigned long )"atomic: atomic primitives" != (unsigned long )((void *)0)) {
      __sput.suite.name = "atomic: atomic primitives";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
    (__sput.overall.suites) ++;
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_atomic_spinlocks";
  ...
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___2 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___2 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___2);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if ((unsigned long )"ftoa: double-to-string conversion" != (unsigned long )((void *)0)) {
      __sput.suite.name = "ftoa: double-to-string conversion";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
    (__sput.overall.suites) ++;
  ...
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___3 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___3 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___3);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if ((unsigned long )"statsd: packet parsing" != (unsigned long )((void *)0)) {
      __sput.suite.name = "statsd: packet parsing";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
    (__sput.overall.suites) ++;
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_statsd_msg__parse_strings";
  ...
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___4 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___4 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___4);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if ((unsigned long )"tags: associative key value parsing" != (unsigned long )((void *)0)) {
      __sput.suite.name = "tags: associative key value parsing";
    } else {
      __sput.suite.name = "Unlabeled Suite";
    }
    (__sput.overall.suites) ++;
  ...
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_tag_parsing";
    test_tag_parsing();
    break;
  }
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_tag_storage";
    test_tag_storage();
    break;
  }
  while (1) {
    ...
    memset((void *)(& __sput.test), 0, sizeof(__sput.test));
    __sput.test.name = "test_tag_offset";
    test_tag_offset();
    break;
  }
  while (1) {
    ...
    if (__sput.suite.name) {
      while (1) {
        ...
        if (__sput.suite.checks) {
          failp___6 = (float )(((double )__sput.suite.nok * 100.0) / (double )__sput.suite.checks);
        } else {
          failp___6 = 0.0f;
        }
        fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n--> %lu check(s), %lu ok, %lu failed (%.2f%%)\n",
                __sput.suite.checks, __sput.suite.ok, __sput.suite.nok, (double )failp___6);
        __sput.overall.checks += __sput.suite.checks;
        __sput.overall.ok += __sput.suite.ok;
        __sput.overall.nok += __sput.suite.nok;
        memset((void *)(& __sput.suite), 0, sizeof(__sput.suite));
    ...
    if (__sput.overall.checks) {
      failp___5 = (float )(((double )__sput.overall.nok * 100.0) / (double )__sput.overall.checks);
    } else {
      failp___5 = 0.0f;
    }
    __sput.time.end = time((time_t *)((void *)0));
    if (__sput.overall.nok > 0UL) {
      tmp___1 = 1;
    } else {
      tmp___1 = 0;
    }
    ...
    fprintf((FILE * __restrict  )__sput.out, (char const   * __restrict  )"\n==> %lu check(s) in %lu suite(s) finished after %.2f second(s),\n    %lu succeeded, %lu failed (%.2f%%)\n\n[%s]\n",
            __sput.overall.checks, __sput.overall.suites, tmp___2, __sput.overall.ok,
            __sput.overall.nok, (double )failp___5, tmp___0);
    break;
  }
  if (__sput.overall.nok > 0UL) {
    tmp___3 = 1;
...
#pragma merger("0","/tmp/cil-2E1wqH_z.i","-g,-Wall,-O3,-Wno-strict-aliasing")
static void check_eq(float f , char const   *str ) 
{ 
  char buf[16] ;
  int tmp ;
  ...
  while (1) {
    ...
    __sput.check.line = 7UL;
    __sput.check.cond = "strcmp(str, buf) == 0";
    __sput.check.type = "fail-unless";
    (__sput.test.nr) ++;
    (__sput.suite.checks) ++;
    tmp = strcmp(str, (char const   *)(buf));
    if (tmp == 0) {
      if ((int )__sput.initialized != 6) {
        fputs((char const   * __restrict  )"sput_start_testing() omitted\n", (FILE * __restrict  )stderr);
        exit(1);
...
{ 
  ...
  {
  check_eq((float )0.0, "0");
  check_eq((float )15.0, "15");
  check_eq((float )15.5, "15.5");
  check_eq((float )15.505, "15.505");
  check_eq((float )0.125, "0.125");
  check_eq((float )1234.567, "1234.567");
  check_eq((float )99999.999, "100000");
  check_eq((float )0.999, "0.999");
  return;
}
}
