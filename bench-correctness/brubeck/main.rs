...
pub struct brubeck_metric {
    ...
    pub as_0: __anonunion_as_879286020,
    pub key: [libc::c_char; 0],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union __anonunion_as_879286020 {
...
#[derive(Copy, Clone)]
#[repr(C, align(32))]
pub struct ck_ht_entry(pub ck_ht_entry_Inner);
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn ck_ht_entry_key_set(
    ...
    (*entry).0.key = key as uintptr_t;
    (*entry).0.key_length = key_length as uint64_t;
}
#[inline]
unsafe extern "C" fn ck_ht_entry_value(
    mut entry: *mut ck_ht_entry_t,
) -> *mut libc::c_void {
    return (*entry).0.value as *mut libc::c_void;
}
#[inline]
unsafe extern "C" fn ck_ht_entry_set(
    ...
    (*entry).0.key = key as uintptr_t;
    (*entry).0.value = value as uintptr_t;
    (*entry).0.key_length = key_length as uint64_t;
    (*entry).0.hash = h.value;
}
...
pub unsafe extern "C" fn brubeck_hashtable_find(
    ...
    let mut entry: ck_ht_entry_t = ck_ht_entry(ck_ht_entry_Inner {
        key: 0,
        value: 0,
        key_length: 0,
        hash: 0,
    ...
    match *buffer as libc::c_int {
        ...
        109 => {
            ...
            if *buffer as libc::c_int == 115 as libc::c_int {
                ...
                current_block_28 = 5497192158704825631;
            }
        }
        _ => {
            current_block_28 = 5497192158704825631;
...
unsafe extern "C" fn load_backends(
    ...
    loop {
        ...
        if !type_0.is_null() {
            ...
            if tmp___5 != 0 {
                current_block_27 = 4932987440613885012;
            } else {
...
unsafe extern "C" fn check_tags_equal(
    ...
    let mut tmp: libc::c_int = 0;
    let mut tmp___0: libc::c_int = 0;
    if __sput.initialized as libc::c_int != 6 as libc::c_int {
        fputs(
    ...
    if description as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
        __sput.check.name = description;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 7 as libc::c_ulong;
    __sput
        .check
    ...
    while i < (*y).num_tags as libc::c_int {
        ...
        __sput.check.line = 9 as libc::c_ulong;
        __sput
            .check
        ...
        __sput.check.line = 11 as libc::c_ulong;
        __sput
            .check
...
unsafe extern "C" fn check_equal(
    ...
    __sput.check.line = 18 as libc::c_ulong;
    ...
    if !x.is_null() {
        if y.is_null() {
            current_block_41 = 12279034643799444710;
        } else {
            current_block_41 = 14795216699754490530;
        }
    } else {
        current_block_41 = 14795216699754490530;
    }
    match current_block_41 {
        14795216699754490530 => {
            if !y.is_null() {
                if x.is_null() {
                    current_block_41 = 12279034643799444710;
                } else {
                    current_block_41 = 16405298529286899795;
                }
            } else {
                current_block_41 = 16405298529286899795;
            }
            match current_block_41 {
                12279034643799444710 => {}
                _ => {
                    if __sput.initialized as libc::c_int != 6 as libc::c_int {
                        fputs(
                            b"sput_start_testing() omitted\n\0" as *const u8
                    ...
                    current_block_41 = 15597372965620363352;
                }
            }
        }
        _ => {}
    ...
    __sput.check.line = 19 as libc::c_ulong;
    __sput
        .check
...
pub unsafe extern "C" fn parse(
    ...
    let mut tmp: size_t = 0;
    let mut tmp___0: *mut brubeck_tag_set = 0 as *mut brubeck_tag_set;
    tmp = strlen(source);
    len = tmp as uint16_t;
    str = strdup(source);
    tmp___0 = brubeck_parse_tags(str, len);
    return tmp___0 as *const brubeck_tag_set;
}
unsafe extern "C" fn check_parse(
    ...
    let mut expected: *mut brubeck_tag_set = 0 as *mut brubeck_tag_set;
    let mut tmp: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut tags: *const brubeck_tag_set = 0 as *const brubeck_tag_set;
    let mut tmp___0: *const brubeck_tag_set = 0 as *const brubeck_tag_set;
    tmp = malloc(
    ...
    expected = tmp as *mut brubeck_tag_set;
    memcpy(
    ...
    tmp___0 = parse(source);
    tags = tmp___0;
    check_equal(expected as *const brubeck_tag_set, tags, source);
}
pub unsafe extern "C" fn test_tag_parsing() {
    let mut __constr_expr_0: [brubeck_tag; 0] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 0];
    let mut __constr_expr_1: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_2: [brubeck_tag; 0] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 0];
    let mut __constr_expr_3: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_4: [brubeck_tag; 1] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 1];
    let mut __constr_expr_5: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_6: [brubeck_tag; 1] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 1];
    let mut __constr_expr_7: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_8: [brubeck_tag; 1] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 1];
    let mut __constr_expr_9: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_10: [brubeck_tag; 2] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 2];
    let mut __constr_expr_11: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_12: [brubeck_tag; 2] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 2];
    let mut __constr_expr_13: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_14: [brubeck_tag; 0] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 0];
    let mut __constr_expr_15: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_16: [brubeck_tag; 1] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 1];
    let mut __constr_expr_17: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    let mut __constr_expr_18: [brubeck_tag; 1] = [brubeck_tag {
        key: 0 as *const libc::c_char,
        value: 0 as *const libc::c_char,
    }; 1];
    let mut __constr_expr_19: brubeck_tag_set = brubeck_tag_set {
        index: 0,
        tag_len: 0,
        num_tags: 0,
        tags: [],
    };
    __constr_expr_1.index = 0 as libc::c_uint;
    __constr_expr_1.tag_len = 0 as libc::c_int as uint16_t;
    __constr_expr_1.num_tags = 0 as libc::c_int as uint16_t;
    check_parse(
        b"\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_1,
        __constr_expr_0.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_3.index = 0 as libc::c_uint;
    __constr_expr_3.tag_len = 3 as libc::c_int as uint16_t;
    __constr_expr_3.num_tags = 0 as libc::c_int as uint16_t;
    check_parse(
        b"foo\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_3,
        __constr_expr_2.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_4[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_4[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_5.index = 0 as libc::c_uint;
    __constr_expr_5.tag_len = 7 as libc::c_int as uint16_t;
    __constr_expr_5.num_tags = 1 as libc::c_int as uint16_t;
    check_parse(
        b"foo=bar\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_5,
        __constr_expr_4.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_6[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_6[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_7.index = 0 as libc::c_uint;
    __constr_expr_7.tag_len = 8 as libc::c_int as uint16_t;
    __constr_expr_7.num_tags = 1 as libc::c_int as uint16_t;
    check_parse(
        b",foo=bar\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_7,
        __constr_expr_6.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_8[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_8[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_9.index = 0 as libc::c_uint;
    __constr_expr_9.tag_len = 9 as libc::c_int as uint16_t;
    __constr_expr_9.num_tags = 1 as libc::c_int as uint16_t;
    check_parse(
        b",foo=bar,\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_9,
        __constr_expr_8.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_10[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_10[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_10[1 as libc::c_int as usize]
        .key = b"baz\0" as *const u8 as *const libc::c_char;
    __constr_expr_10[1 as libc::c_int as usize]
        .value = b"42\0" as *const u8 as *const libc::c_char;
    __constr_expr_11.index = 0 as libc::c_uint;
    __constr_expr_11.tag_len = 16 as libc::c_int as uint16_t;
    __constr_expr_11.num_tags = 2 as libc::c_int as uint16_t;
    check_parse(
        b"s,foo=bar,baz=42\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_11,
        __constr_expr_10.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_12[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_12[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_12[1 as libc::c_int as usize]
        .key = b"baz\0" as *const u8 as *const libc::c_char;
    __constr_expr_12[1 as libc::c_int as usize]
        .value = b"42\0" as *const u8 as *const libc::c_char;
    __constr_expr_13.index = 0 as libc::c_uint;
    __constr_expr_13.tag_len = 17 as libc::c_int as uint16_t;
    __constr_expr_13.num_tags = 2 as libc::c_int as uint16_t;
    check_parse(
        b",foo=bar,,baz=42,\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_13,
        __constr_expr_12.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_15.index = 0 as libc::c_uint;
    __constr_expr_15.tag_len = 20 as libc::c_int as uint16_t;
    __constr_expr_15.num_tags = 0 as libc::c_int as uint16_t;
    check_parse(
        b"s,junk,=,junk=,=junk\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_15,
        __constr_expr_14.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_16[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_16[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_17.index = 0 as libc::c_uint;
    __constr_expr_17.tag_len = 11 as libc::c_int as uint16_t;
    __constr_expr_17.num_tags = 1 as libc::c_int as uint16_t;
    check_parse(
        b"s,foo===bar\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_17,
        __constr_expr_16.as_mut_ptr() as *const brubeck_tag,
    );
    __constr_expr_18[0 as libc::c_int as usize]
        .key = b"foo\0" as *const u8 as *const libc::c_char;
    __constr_expr_18[0 as libc::c_int as usize]
        .value = b"bar\0" as *const u8 as *const libc::c_char;
    __constr_expr_19.index = 0 as libc::c_uint;
    __constr_expr_19.tag_len = 8 as libc::c_int as uint16_t;
    __constr_expr_19.num_tags = 1 as libc::c_int as uint16_t;
    check_parse(
        b"foo=bar,\0" as *const u8 as *const libc::c_char,
        &mut __constr_expr_19,
        __constr_expr_18.as_mut_ptr() as *const brubeck_tag,
    );
}
pub unsafe extern "C" fn get_tag_set(
    ...
    let mut tag_str_len: uint16_t = 0;
    let mut tmp: size_t = 0;
    let mut tmp___0: *const brubeck_tag_set = 0 as *const brubeck_tag_set;
    tmp = strlen(tag_str);
    tag_str_len = tmp as uint16_t;
    tmp___0 = brubeck_get_tag_set(tags, tag_str, tag_str_len);
    return tmp___0;
}
pub unsafe extern "C" fn test_tag_storage() {
    let mut tags: *mut brubeck_tags_t = 0 as *mut brubeck_tags_t;
    let mut tmp: *mut brubeck_tags_t = 0 as *mut brubeck_tags_t;
    ...
    let mut tmp___0: *const brubeck_tag_set = 0 as *const brubeck_tag_set;
    let mut tmp___1: *const brubeck_tag_set = 0 as *const brubeck_tag_set;
    tmp = brubeck_tags_create(1024 as libc::c_int as uint64_t);
    tags = tmp;
    ...
    if b"not null\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"not null\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 91 as libc::c_ulong;
    __sput.check.cond = b"t1 == NULL\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-if\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if t1 as libc::c_ulong == 0 as *mut libc::c_void as libc::c_ulong {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    tmp___0 = parse(b",foo=bar\0" as *const u8 as *const libc::c_char);
    check_equal(t1, tmp___0, str);
    if __sput.initialized as libc::c_int != 6 as libc::c_int {
        fputs(
            b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
            stderr,
    ...
    if b"index\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"index\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 93 as libc::c_ulong;
    __sput.check.cond = b"t1->index == 1\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !((*t1).index == 1 as libc::c_uint) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 96 as libc::c_ulong;
    ...
    tmp___1 = parse(b",foo=bar\0" as *const u8 as *const libc::c_char);
    check_equal(t2, tmp___1, str);
    if __sput.initialized as libc::c_int != 6 as libc::c_int {
        fputs(
            b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
            stderr,
    ...
    if b"caching\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"caching\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 98 as libc::c_ulong;
    __sput.check.cond = b"t1 == t2\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(t1 as libc::c_ulong == t2 as libc::c_ulong) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 104 as libc::c_ulong;
    __sput.check.cond = b"t2->index == 2\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !((*t2).index == 2 as libc::c_uint) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
...
pub unsafe extern "C" fn check_tag_offset(
    ...
    if str as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
        __sput.check.name = str;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 109 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    tmp = brubeck_tag_offset(str);
    if tmp as libc::c_int == offset as libc::c_int {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
...
unsafe extern "C" fn new_metric___0(
    ...
    metric = tmp___0 as *mut brubeck_metric;
    memcpy(
        ((*metric).key).as_mut_ptr() as *mut libc::c_void,
...
pub unsafe extern "C" fn test_mstore__save() {
    ...
    let mut metric: *mut brubeck_metric = 0 as *mut brubeck_metric;
    let mut tmp: bool = false;
    let mut buffer___0: [libc::c_char; 64] = [0; 64];
    let mut len: uint16_t = 0;
    let mut tmp___0: libc::c_int = 0;
    let mut tmp___1: *mut brubeck_metric = 0 as *mut brubeck_metric;
    ...
    while i < nmetrics {
        ...
        metric = new_metric___0(buffer.as_mut_ptr() as *const libc::c_char);
        tmp = brubeck_hashtable_insert(
            store,
            ((*metric).key).as_mut_ptr() as *const libc::c_char,
            (*metric).key_len,
            metric,
    ...
    if b"stored 15000 metrics in table\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"stored 15000 metrics in table\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 34 as libc::c_ulong;
    ...
    while i < nmetrics + 1 as libc::c_int {
        tmp___0 = sprintf(
            buffer___0.as_mut_ptr(),
            b"github.test.metric.%d\0" as *const u8 as *const libc::c_char,
            i,
        );
        len = tmp___0 as uint16_t;
        tmp___1 = brubeck_hashtable_find(
            store,
            buffer___0.as_mut_ptr() as *const libc::c_char,
            len,
        );
        if tmp___1.is_null() {
            break;
    ...
    if b"lookup all metrics from table\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"lookup all metrics from table\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 47 as libc::c_ulong;
    __sput.check.cond = b"i == nmetrics\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
...
unsafe extern "C" fn spawn_threads(
    ...
    i = 0 as libc::c_int as size_t;
    while i < 16 as libc::c_ulong {
        pthread_create(
            &mut *threads.as_mut_ptr().offset(i as isize) as *mut pthread_t,
            0 as *mut libc::c_void as *const pthread_attr_t,
            thread_ptr,
            ptr,
        );
...
unsafe extern "C" fn thread_spinlock(mut ptr: *mut libc::c_void) -> *mut libc::c_void {
    let mut spt: *mut spinlock_test = 0 as *mut spinlock_test;
    let mut i: size_t = 0;
    let mut v: libc::c_double = 0.;
    spt = ptr as *mut spinlock_test;
    i = 0 as libc::c_int as size_t;
    while i < 4096 as libc::c_ulong {
        pthread_spin_lock(&mut (*spt).lock);
        v = (*spt).value;
        v = ::std::ptr::read_volatile::<libc::c_double>(&v as *const libc::c_double)
            + 0.5f64;
        (*spt).value = v;
...
pub unsafe extern "C" fn test_atomic_spinlocks() {
    ...
    if b"spinlock doesn't race\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"spinlock doesn't race\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 38 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(spt.value == 65536 as libc::c_int as libc::c_double * 0.5f64) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
...
unsafe extern "C" fn thread_histo(mut ptr: *mut libc::c_void) -> *mut libc::c_void {
    let mut t: *mut histo_test = 0 as *mut histo_test;
    let mut i: size_t = 0;
    let mut hsample: brubeck_histo_sample = brubeck_histo_sample {
        sum: 0.,
        min: 0.,
    ...
    let mut tmp: libc::c_int = 0;
    t = ptr as *mut histo_test;
    i = 0 as libc::c_int as size_t;
    while i < 32768 as libc::c_ulong {
        tmp = rand();
...
pub unsafe extern "C" fn test_histogram__single_element() {
    ...
    if b"histogram size\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"histogram size\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 48 as libc::c_ulong;
    ...
    if b"histogram value count\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"histogram value count\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 49 as libc::c_ulong;
    __sput.check.cond = b"h.count == 1\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(h.count == 1 as libc::c_uint) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    if b"sample.min\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.min\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 53 as libc::c_ulong;
    ...
    if b"sample.max\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.max\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 54 as libc::c_ulong;
    ...
    if b"sample.percentile[3]\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"sample.percentile[3]\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 55 as libc::c_ulong;
    __sput
        .check
    ...
    if b"sample.mean\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.mean\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 56 as libc::c_ulong;
    ...
    if b"sample.count\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.count\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 57 as libc::c_ulong;
    __sput.check.cond = b"sample.count == 1\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(sample.count == 1 as libc::c_int as value_t) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    if b"sample.sum\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.sum\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 58 as libc::c_ulong;
...
pub unsafe extern "C" fn test_histogram__large_range() {
    ...
    __sput.check.line = 73 as libc::c_ulong;
    __sput.check.cond = b"sample.min == 42.0\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 74 as libc::c_ulong;
    ...
    if b"sample.median\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput.check.name = b"sample.median\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 75 as libc::c_ulong;
...
pub unsafe extern "C" fn test_histogram__multisamples() {
    ...
    while i < 8 as libc::c_ulong {
        ...
        while j < 128 as libc::c_ulong {
            brubeck_histo_push(
                &mut h,
                j.wrapping_add(1 as libc::c_ulong) as libc::c_double,
                1.0f64,
            );
            j = j.wrapping_add(1);
        }
        ...
        __sput.check.line = 89 as libc::c_ulong;
        ...
        if b"histogram value count\0" as *const u8 as *const libc::c_char
            as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
        {
            __sput
                .check
        ...
        __sput.check.line = 94 as libc::c_ulong;
        ...
        __sput.check.line = 95 as libc::c_ulong;
        ...
        __sput.check.line = 97 as libc::c_ulong;
        ...
        __sput.test.nr = (__sput.test.nr).wrapping_add(1);
        __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
        if !(sample.count == 128 as libc::c_int as value_t) {
            if __sput.initialized as libc::c_int != 6 as libc::c_int {
                fputs(
                    b"sput_start_testing() omitted\n\0" as *const u8
                        as *const libc::c_char,
        ...
        __sput.check.line = 99 as libc::c_ulong;
        __sput
            .check
...
pub unsafe extern "C" fn test_histogram__with_sample_rate() {
    ...
    __sput.check.line = 113 as libc::c_ulong;
    __sput.check.cond = b"h.size == 128\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 114 as libc::c_ulong;
    __sput.check.cond = b"h.count == 1280\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(h.count == 1280 as libc::c_uint) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 118 as libc::c_ulong;
    __sput.check.cond = b"sample.min == 1.0\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 119 as libc::c_ulong;
    __sput.check.cond = b"sample.max == 128.0\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 120 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.check.line = 121 as libc::c_ulong;
    __sput.check.cond = b"sample.mean == 64.5\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 122 as libc::c_ulong;
    __sput.check.cond = b"sample.count == 1280\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(sample.count == 1280 as libc::c_int as value_t) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 123 as libc::c_ulong;
...
static mut HISTO_CAP: libc::c_ulong = 65535 as libc::c_int as size_t;
pub unsafe extern "C" fn test_histogram__capacity() {
    ...
    j = 0 as libc::c_int as size_t;
    while j < HISTO_CAP.wrapping_add(500 as libc::c_ulong) {
        brubeck_histo_push(
            &mut h,
            j.wrapping_add(1 as libc::c_ulong) as libc::c_double,
            1.0f64,
    ...
    __sput.check.line = 138 as libc::c_ulong;
    ...
    __sput.check.line = 139 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(h.count as libc::c_ulong == HISTO_CAP.wrapping_add(500 as libc::c_ulong)) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 143 as libc::c_ulong;
    __sput.check.cond = b"sample.min == 1.0\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 144 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.check.line = 145 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(sample.count == HISTO_CAP.wrapping_add(500 as libc::c_ulong) as value_t) {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
                stderr,
    ...
    __sput.check.line = 150 as libc::c_ulong;
    __sput.check.cond = b"h.size == HISTO_CAP\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 152 as libc::c_ulong;
    __sput
        .check
    ...
    if !(h.count as libc::c_ulong
        == HISTO_CAP
            .wrapping_add(500 as libc::c_ulong)
    ...
    __sput.check.line = 156 as libc::c_ulong;
    __sput.check.cond = b"sample.min == 1.0\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    ...
    __sput.check.line = 157 as libc::c_ulong;
    __sput
        .check
        .cond = b"sample.max == (double)HISTO_CAP\0" as *const u8 as *const libc::c_char;
    __sput.check.type_0 = b"fail-unless\0" as *const u8 as *const libc::c_char;
    ...
    __sput.check.line = 158 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    if !(sample.count
        == HISTO_CAP.wrapping_add(500 as libc::c_ulong).wrapping_mul(10 as libc::c_ulong)
            as value_t)
    {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
...
unsafe extern "C" fn must_parse(
    ...
    if msg_text as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong {
        __sput.check.name = msg_text;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 15 as libc::c_ulong;
    __sput
        .check
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    tmp___0 = brubeck_statsd_msg_parse(
        &mut msg,
        buffer.as_mut_ptr(),
    ...
    if b"msg.value == expected\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"msg.value == expected\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 16 as libc::c_ulong;
    ...
    if b"msg.sample_rate == expected\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"msg.sample_rate == expected\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 17 as libc::c_ulong;
    __sput
        .check
    ...
    if b"msg.modifiers == expected\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .check
            .name = b"msg.modifiers == expected\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.check.name = b"Unlabeled Check\0" as *const u8 as *const libc::c_char;
    }
    __sput.check.line = 18 as libc::c_ulong;
...
unsafe extern "C" fn must_not_parse(mut msg_text: *const libc::c_char) {
    ...
    __sput.check.line = 29 as libc::c_ulong;
    __sput
        .check
        .cond = b"brubeck_statsd_msg_parse(&msg, buffer, buffer + len, 0.001) < 0\0"
        as *const u8 as *const libc::c_char;
...
unsafe fn main_0(
    ...
    let mut failp: libc::c_float = 0.;
    let mut failp___0: libc::c_float = 0.;
    let mut failp___1: libc::c_float = 0.;
    let mut failp___2: libc::c_float = 0.;
    let mut failp___3: libc::c_float = 0.;
    let mut failp___4: libc::c_float = 0.;
    let mut failp___5: libc::c_float = 0.;
    let mut failp___6: libc::c_float = 0.;
    let mut tmp___0: *const libc::c_char = 0 as *const libc::c_char;
    let mut tmp___1: libc::c_int = 0;
    ...
    __sput.out = stdout;
    __sput.time.start = time(0 as *mut libc::c_void as *mut time_t);
    __sput.initialized = 6 as libc::c_int as libc::c_char;
    if __sput.initialized as libc::c_int != 6 as libc::c_int {
        fputs(
            b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
            stderr,
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp = (__sput.suite.nok as libc::c_double * 100.0f64
    ...
    if b"histogram: time/data series aggregation\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"histogram: time/data series aggregation\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___0 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___0 = 0.0f32;
        }
    ...
    if b"mstore: concurrency test for metrics hash table\0" as *const u8
        as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"mstore: concurrency test for metrics hash table\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___1 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___1 = 0.0f32;
        }
    ...
    if b"atomic: atomic primitives\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"atomic: atomic primitives\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    __sput.overall.suites = (__sput.overall.suites).wrapping_add(1);
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___2 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___2 = 0.0f32;
        }
    ...
    if b"ftoa: double-to-string conversion\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"ftoa: double-to-string conversion\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___3 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___3 = 0.0f32;
        }
    ...
    if b"statsd: packet parsing\0" as *const u8 as *const libc::c_char as libc::c_ulong
        != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"statsd: packet parsing\0" as *const u8 as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    __sput.overall.suites = (__sput.overall.suites).wrapping_add(1);
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___4 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___4 = 0.0f32;
        }
    ...
    if b"tags: associative key value parsing\0" as *const u8 as *const libc::c_char
        as libc::c_ulong != 0 as *mut libc::c_void as libc::c_ulong
    {
        __sput
            .suite
            .name = b"tags: associative key value parsing\0" as *const u8
            as *const libc::c_char;
    } else {
        __sput.suite.name = b"Unlabeled Suite\0" as *const u8 as *const libc::c_char;
    }
    ...
    if !(__sput.suite.name).is_null() {
        ...
        if __sput.suite.checks != 0 {
            failp___6 = (__sput.suite.nok as libc::c_double * 100.0f64
                / __sput.suite.checks as libc::c_double) as libc::c_float;
        } else {
            failp___6 = 0.0f32;
        }
    ...
    if __sput.overall.checks != 0 {
        failp___5 = (__sput.overall.nok as libc::c_double * 100.0f64
            / __sput.overall.checks as libc::c_double) as libc::c_float;
    } else {
        failp___5 = 0.0f32;
    }
    __sput.time.end = time(0 as *mut libc::c_void as *mut time_t);
    if __sput.overall.nok > 0 as libc::c_ulong {
        tmp___1 = 1 as libc::c_int;
    } else {
        tmp___1 = 0 as libc::c_int;
    }
    if tmp___1 == 0 as libc::c_int {
        tmp___0 = b"SUCCESS\0" as *const u8 as *const libc::c_char;
    } else {
        tmp___0 = b"FAILURE\0" as *const u8 as *const libc::c_char;
    }
    tmp___2 = difftime(__sput.time.end, __sput.time.start);
    fprintf(
        __sput.out,
...
unsafe extern "C" fn check_eq(mut f: libc::c_float, mut str: *const libc::c_char) {
    ...
    __sput.test.nr = (__sput.test.nr).wrapping_add(1);
    __sput.suite.checks = (__sput.suite.checks).wrapping_add(1);
    tmp = strcmp(str, buf.as_mut_ptr() as *const libc::c_char);
    if tmp == 0 as libc::c_int {
        if __sput.initialized as libc::c_int != 6 as libc::c_int {
            fputs(
                b"sput_start_testing() omitted\n\0" as *const u8 as *const libc::c_char,
